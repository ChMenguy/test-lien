            ...
            <form class="w-full max-w-lg mx-auto mt-10">
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="number"></input>
                        <a href="#">
                            <p class="text-yellow-500 text-right text-xs italic hover:text-yellow-600 underline">Où trouver votre identifiant</p>
                        </a>                      
                    </div>
                </div>
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="email"></input>
                        <input type="radio" class="appearance-none checked:bg-gray-900 checked:border-transparent ..."></input>
